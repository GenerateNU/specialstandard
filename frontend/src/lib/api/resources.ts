...
export const postResources = (
  ...
  return axios.post(`/resources`, createResourceBody, options);
};

export const getPostResourcesMutationOptions = <
  TError = AxiosError<Error | Error>,
  TContext = unknown,
>(options?: {
...
export type PostResourcesMutationResult = NonNullable<
  Awaited<ReturnType<typeof postResources>>
>;
...
export const patchResourcesId = (
  ...
  return axios.patch(`/resources/${id}`, updateResourceBody, options);
};

export const getPatchResourcesIdMutationOptions = <
  TError = AxiosError<Error | Error>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type PatchResourcesIdMutationResult = NonNullable<
  Awaited<ReturnType<typeof patchResourcesId>>
>;
 ...
 * @summary Update a resource
 */
export const usePatchResourcesId = <
  TError = AxiosError<Error | Error>,
  TContext = unknown,
>(
  options?: {
...
export const deleteResourcesId = (
  ...
  return axios.delete(`/resources/${id}`, options);
};

export const getDeleteResourcesIdMutationOptions = <
...
export type DeleteResourcesIdMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteResourcesId>>
>;
 ...
 * @summary Delete a resource
 */
export const useDeleteResourcesId = <
  TError = AxiosError<Error>,
  TContext = unknown,
>(
  options?: {
