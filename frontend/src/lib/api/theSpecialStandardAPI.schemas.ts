...
export type GetNewsletterByDateParams = {
  /**
   * The date to retrieve the newsletter for (YYYY-MM-DD format)
   */
  date: string;
};

export type GetNewsletterByDate200 = {
  /** Presigned URL to access the newsletter from S3 (valid for 1 hour) */
  s3_url: string;
};
