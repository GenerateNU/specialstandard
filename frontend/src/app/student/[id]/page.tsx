      ...
      <div className="min-h-screen h-screen flex items-center justify-center bg-background">
        ...
        >
          ...
          <div className="flex gap-8">
            ...
            {/* student schedule */}
            <div
              className={`flex-[3] ${CORNER_ROUND} overflow-hidden bg-accent flex flex-col justify-between ${PADDING}`}
            >
            ...
            <div
              className={`bg-accent flex-[2] flex flex-col items-center justify-between ${CORNER_ROUND} ${PADDING}`}
            >
