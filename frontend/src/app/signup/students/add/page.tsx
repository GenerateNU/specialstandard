...
export default function AddStudentsPage() {
  ...
  const availableSchools = therapistProfile?.schoolIds 
    ? schools.filter(school => therapistProfile.schoolIds.includes(school.id!.toString()))
    : schools
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      existingStudents.push({
        ...
        school: availableSchools.find(s => s.id!.toString() === formData.school)?.name,
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              <p className="text-xs text-secondary mb-1">First Name (Initial Only)</p>
              <Input
            ...
            <div className="flex-1">
              <p className="text-xs text-secondary mb-1">Last Name (Initial Only)</p>
              <Input
          ...
          {/* Date of Birth */}
          <div>
            <p className="text-xs text-secondary mt-1">Date of birth (optional)</p>
            <Input
              type="date"
              value={formData.dob}
