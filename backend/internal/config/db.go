...
type DB struct {
	...
	// Add these:
	MaxOpenConns    int `env:"DB_MAX_OPEN_CONNS" envDefault:"5"`          // max connections to keep open
	MaxIdleConns    int `env:"DB_MAX_IDLE_CONNS" envDefault:"2"`          // max idle connections
